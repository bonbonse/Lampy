...
namespace Player
{
    public class PlayerBehaviourHandler : MonoBehaviour
    {
        ...
        private void InitBehaviours()
        {
            ...
            behavioursMap[typeof(PlayerBehaviourWorking)] = new PlayerBehaviourWorking();
        }
        private void Update()
        {
        ...
        public void SetBehaviourWorking()
        {
            var behaviour = GetBehaviour<PlayerBehaviourWorking>();
            SetBehaviour(behaviour);
        }
